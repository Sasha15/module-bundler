...
function createAsset(filename) {
    ...
    //method parse has several optional. one of them is "sourceType" - indicate the mode the code should be parsed in (script or module)
    ...
    //traverse through the node ImportDeclaration to see only "import" part of the parsed code
    traverse(ast, {
...
function createGraph(entry) {
    ...
    for(const asset of queue) {
        // This is the directory this module is in. getting this directory using Node module path
...
console.log(result);
//To check this code - just run in command line "node bundler.js", copy output code and paste to any 
//browser console. You should get "hello Module bundler !"